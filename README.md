...
|Project_5 - Recommendation system creation for social network posts. (__[github](https://github.com/melloignat/proj_5)__)|Building a service based on the FAST API, which will process HTTP requests to the database and return top N posts that might be of user interest based on previous user interactions. Two reccomendation models were created (basic and advanced) and final selection was made via A/B testing | FastAPI, SQLAlchemy, ORM, Catboost, Hugging Face, DistilBERT, Feature engineering | Reccomendation systems |
